            ...
            <GridItem xs={12} sm={12} md={12}>
                <Card>
                    <CardHeader color="primary">
                        <h4 className={classes.cardTitleWhite}>Intern's Daily Diary</h4>
                        <p className={classes.cardCategoryWhite}>
                            To be filled by the Intern Please ensure to upload duly filled set of forms at end of four weeks to the provided page.
                        </p>
                    </CardHeader>
                    <CardBody>
